...
Tommy = Store(name='Tommy', url='https://www.tommy.hr/', locations=StoreLocations['studenac'],
...
DjeloVodice = Store(name='Djelo Vodice', url='https://djelo-vodice.hr/', locations={},
...
Jadranka = Store(name='Jadranka', url='https://jadranka-trgovina.com/', locations={},
...
Brodokomerc = Store(name='Brodokomerc', url='http://brodokomerc.hr/', locations={},
...
JedinstvoLabin = Store(name='Jedinstvo Labin', url='https://www.jedinstvo-labin.hr/', locations={},
                       fetch_prices=fetch_jedinstvo_labin_prices)
Croma = Store(name='Croma-Varaždin', url='https://croma.com.hr/', locations={}, fetch_prices=fetch_croma_prices,
              id='croma')
